...
### 1. 트레잇 및 능력 데이터베이스 대규모 확장 (Fate Series)
- **목표:** Fate 시리즈의 개성 강한 캐릭터(서번트)들을 분석하여, 범용적으로 사용할 수 있는 고품질의 트레잇(Trait)과 능력(Skill) 데이터를 대량 확보합니다.
- **작업 내용:**
...
- [x] **트레잇 데이터 확장:** `11_지역환경.md`, `12_외교.md` 추가 및 `00_유형.md` 개념 정립 (총 13종 시스템 구축)
