    ...
    - **앞으로 분석할 대상 (체크리스트)**
        - **Fate/Stay Night (마스터 8인 / 서번트 9인)**
            ...
            - **마스터 8인**
                ...
                - [ ] 마토 신지 (Rider의 명목/대리 마스터)
                - [x] 이리야스필 폰 아인츠베른 (Berserker 마스터)
                - [ ] 쿠즈키 소이치로 (Caster 마스터)
                - [ ] 마토 조켄 (진 어쌔신 마스터 / Heaven's Feel)
                - [ ] 바젯 프라가 맥레미츠 (Lancer의 원래 마스터)
                - [ ] 코토미네 키레이 (Lancer 탈취 / 길가메시 잔존 계약)
            - **서번트 9인**
                ...
                - [x] 라이더: 메두사 (Medusa)
                - [ ] 캐스터: 메데이아 (Medea)
                - [ ] 어쌔신(가짜): 사사키 코지로 (Sasaki Kojirou)
                - [ ] 어쌔신(진): 저주의 팔의 하산 (Hassan of the Cursed Arm)
                - [x] 버서커: 헤라클레스 (Heracles)
                - [ ] 길가메시 (Gilgamesh) *(4차 잔존/개입)*
