...
- **주로 접하는 사람들 (PEOPLE THE CHARACTER INTERACTS WITH)**:
    - 쉼표로 나열.
- **직업이 캐릭터의 욕구에 미치는 영향 (HOW THE OCCUPATION MIGHT IMPACT ONE'S BASIC NEEDS)**:
    - (메슬로 계층이론에 해당하는 각 욕구별 설명.)
- **캐릭터가 이 직업을 택한 이유 (REASONS FOR PURSUING THIS CAREER)**:
    - 불릿으로 나열.
